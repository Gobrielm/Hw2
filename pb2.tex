...
\hspace*{6mm} Now consider the case where our house is at h. The function considers some range $[i, 2i]$ where $i=\lfloor{log_2(h)}\rfloor$. We also know this will return the correct result as, we know $h >= i$ and $h <= 2i$. Meaning we have not throw out the correct h and do not have to consider any previous numbers.\\
